...
يجب عليك شحن رصيدك أولاً قبل استخدام باقي خدمات البوت.

اختر طريقة الشحن من الأزرار أدناه فقط.
يمكنك أيضاً استخدام كود هدية من الأدمن أو من صفحتنا/قناتنا.
...
""",
        "deposit_required": """🔒 يجب إتمام الشحن أولاً

لا يمكنك المتابعة قبل شحن رصيد البوت مرة واحدة على الأقل.

الترتيب:
1️⃣ الاشتراك بالقناة
2️⃣ شحن البوت
3️⃣ إنشاء حساب Ichancy
""",
        "ichancy_required": """2️⃣ الخطوة الثانية — حساب Ichancy

تم الشحن بنجاح ✅
الآن يجب إنشاء حساب Ichancy (أو ربط حساب موجود) لإكمال التسجيل وفتح باقي الخدمات.
