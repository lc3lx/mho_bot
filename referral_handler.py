...
class ReferralHandler:
    ...
    async def show_referral_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        text = (
            "👑 جيش نابليون\n\n"
            "مو نظام إحالة عادي\n"
            "هاد النظام الأقوى والأفضل\n\n"
            "هون كل رفيق نشط بيكبر جيشك\n"
            "وبزيد رتبتك ونسبتك 🚀\n\n"
            "🎖️ الرتب:\n\n"
            "🥉 جندي نابليون\n"
            "5 وما فوق إحالات نشطة ← نسبتك 10%\n\n"
            "🥈 قائد الكتيبة\n"
            "20 إحالة نشطة وما فوق ← نسبتك 12%\n\n"
            "🥇 جنرال نابليون\n"
            "75 إحالة نشطة وما فوق ← نسبتك 16%\n\n"
            "👑 الإمبراطور\n"
            "150 إحالة نشطة وما فوق ← نسبتك 18%\n\n"
            "🏛️ مارشال الإمبراطورية\n"
            "500 إحالة نشطة وما فوق ← نسبتك تتراوح بين 20% لـ 25%\n\n"
            "🔥 وللنخبة النسبة ممكن توصل حتى 27%\n\n"
            "━━━━━━━━━━━━\n\n"
            "💰 عمولتك بتنحسب تلقائياً\n"
            "⏳ بتتراجع قبل الاعتماد\n"
            "💵 وبعد اعتمادها بتصير جاهزة للسحب\n\n"
            "وكلشي قدام عينك\n"
            "إحالاتك ورتبتك ونسبتك وعمولاتك\n\n"
            "يعني ما عاد اسمها جيب رفيق وخد عمولة 😂\n"
            "هاد جيش كامل\n"
            "كل ما كبر… بتكبر رتبتك ونسبتك معه 👑\n\n"
            "━━━━━━━━━━━━\n\n"
